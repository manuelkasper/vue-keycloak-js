...
export interface VueKeycloakInstance {
  ...
  login?(options?: KeycloakLoginOptions): Promise<void, void>; // [Keycloak] login function
  loginFn?(options?: KeycloakLoginOptions): Promise<void, void>; // Alias for login
  // This is not defined in keycloak
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  logoutFn?(options?: any): Promise<void, void> | void; // Keycloak logout function
  ...
  register?(options?: KeycloakLoginOptions): Promise<void, void>; // Keycloak register function
  accountManagement?(): Promise<void, void>; // Keycloak accountManagement function
  createAccountUrl?(): string; // Keycloak createAccountUrl function
  loadUserProfile?(): Promise<KeycloakProfile, void>; // Keycloak loadUserProfile function
